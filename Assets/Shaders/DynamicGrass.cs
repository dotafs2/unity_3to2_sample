...
public static class Tool_Spawn
{
    /// <summary>
    /// Spawns a GameObject with specified parameters.
    /// </summary>
    /// <param name="isActive">Whether the GameObject should be active upon creation.</param>
    /// <param name="prefab">The prefab to instantiate.</param>
    /// <param name="parent">The parent GameObject to attach the new object to.</param>
    ...
    /// <param name="rotation">The local rotation relative to the parent.</param>
    /// <param name="worldPositionStays">Whether to keep the world position the same after setting the parent.</param>
        ...
        bool worldPositionStays)
    {
        if (prefab == null)
        {
            Debug.LogError("Prefab is null. Cannot instantiate GameObject.");
            return null;
        }
